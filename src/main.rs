...
async fn main() {
  ...
  let remote_node_1 = remote_node_ref::RemoteNodeRef::new(
    NodeId(1),
    "localhost".to_string(),
    8080,
  );

  let remote_node_2 = remote_node_ref::RemoteNodeRef::new(
    NodeId(2),
    "localhost".to_string(),
    8081,
  );

  let remote_node_3 = remote_node_ref::RemoteNodeRef::new(
    NodeId(3),
    "localhost".to_string(),
    8082,
  );
